...
<section class="content">    
    ...
    <frm:form modelAttribute="modeloMenu" method="post" action="${urlsave}" class="form-horizontal" >
            ...
            <div class="box-body">
                ...
                <div class="form-group">                    
                    <frm:label path="etiqueta" class="col-sm-2 control-label" >Etiqueta:</frm:label>
                    <div class="col-sm-10">
                    <frm:input path="etiqueta" class="form-control" />
                    </div>
                </div>                   
                ...
                <div class="form-group">                    
                    <frm:label path="imagen" class="col-sm-2 control-label" >Imagen:</frm:label>
                    <div class="col-sm-10">
                    <frm:input path="imagen" class="form-control" />
                    </div>
                </div>
              ...
              <div class="box-footer" style="margin-left: 80px">                
                  ...
                  &nbsp;&nbsp;
                  <a href="${pageContext.request.contextPath}/mainMenu" class="btn btn-primary">Cancelar</a> 
              </div>            
    </frm:form>
</div>
